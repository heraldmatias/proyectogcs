...
class Twitter(models.Model):
    ...
    cuentatw = models.CharField(verbose_name='Nombres', max_length=100,)
...
class TwitterDetalle(models.Model):
    ...
    fechadettw = models.DateTimeField(verbose_name='Fecha de los tweets',)
    tweets = models.IntegerField(verbose_name='Numero de tweets',)
    siguiendo = models.IntegerField(verbose_name='Numero de siguiendo', blank=True, null=True)
    seguidores = models.IntegerField(verbose_name='Numero de seguidores',)
